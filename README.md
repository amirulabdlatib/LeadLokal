# LeadLokal - Mini CRM (Malaysia-Focused)

A lightweight CRM system designed for SMEs in Malaysia.  
This CRM includes essential modules: Users, Roles, Products, Leads, Clients, Deals (Sales Pipeline), Tasks, Activity Logs, and Dashboard.
...
- [ ] Add new lead  
- [ ] Lead list & search  
- [ ] Lead status: New, Contacted, Qualified, Not Interested  
- [ ] Lead details page  
...
- [ ] **Deal value auto-calculated from selected products**  
...
- [ ] **Calculate deal value from selected products**  
